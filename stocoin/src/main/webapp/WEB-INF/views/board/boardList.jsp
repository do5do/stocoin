...
<html>
<head>
<style type="text/css">@import url("/stocoin/resources/bootstrap/css/board.css")</style>
<!-- <link rel="stylesheet" type="text/css" href="/stocoin/resources/bootstrap/css/board.css"> -->
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link active"
			data-bs-toggle="tab" href="#home">뉴스</a></li>
		<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
			href="#profile">공지사항</a></li>		
		<li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
			href="#profile">문의글</a></li>
	</ul>
